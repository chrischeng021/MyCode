...
public class ArrayUtils {
    ...
    // ??????????????n ?? start ??
    // ???? nums ???????nums[i] = start + 2*i???��?? 0 ??????? n == nums.length ??
    // ???? nums ??????????��???XOR????????????
    ...
    public boolean checkPossibility(int[] nums) {
        ...
        for(int i = 1; i < nums.length; i++){
            if(nums[i - 1] > nums[i]){
                ...
                // ?????????? 3??4??2??3???? i = 2 ? 4 > 2
                // ???????????? ??2???????4??��
                // ????2????????????nump[i] >= nums[i - 1],??????nums[3] < nums[1](3 < 4)???????????4??��
                // ?????4??��????????????nums[0] > nums[2](3 > 2), ?????????????
    ...
    /**
     * ???????????0????1????????? A??????????N_i?????A[0] ???A[i]???? i????????��?????????????????????????����???????����????
     * ?????????��??answer????��??N_i?????? 5???????????answer[i] ??true??????? false??
...
//    }
    ...
    **/
    ...
    // ?????????????the game of master mind?????�Q?????
    // ???????4?????????????????????????????R?????????Y?????????G?????????B???????��???????????RGGB 4?????1????????2??3????????4????????
    // ??????????????????????????????????????YRGB????????????????????????��????��?????????????????��????????????��?��???��???
    // ????????��?????????��???��???
    // ?????????????solution????????guess????��???????????????��?��???��????answer??????answer[0]????��??????answer[1]?��???��??????
